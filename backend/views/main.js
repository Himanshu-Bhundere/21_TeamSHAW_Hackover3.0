...
const hackathonTexture = new THREE.TextureLoader().load('hackathon1.jpg');
const communityTexture = new THREE.TextureLoader().load('community_service.jpeg')
const trekTexture = new THREE.TextureLoader().load('trek.jpeg')
...
function moveCamera() {
  ...
  // hackathon.rotation.y += 0.01;
  // hackathon.rotation.z += 0.01;
  // community.rotation.y += 0.02;
  // community.rotation.z += 0.02;
